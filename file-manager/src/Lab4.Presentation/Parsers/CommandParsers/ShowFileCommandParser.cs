...
public sealed class ShowFileCommandParser : ICommandParser
{
    private readonly IReadOnlyList<IPositionalApplier<ShowFileCommandBuilder>> _positionalAppliers;

    private readonly IFlagApplierLink<ShowFileCommandBuilder>? _flagApplierChain;

    public ShowFileCommandParser(
        IReadOnlyList<IPositionalApplier<ShowFileCommandBuilder>> positionalAppliers,
        IFlagApplierLink<ShowFileCommandBuilder>? applierChain)
    {
    ...
    private IParsingError? ParsePositional(ShowFileCommandBuilder builder, string[] tokens, ref int currentIndex)
    {
        foreach (IPositionalApplier<ShowFileCommandBuilder> positionalArgument
    ...
    private IParsingError? ParseFlag(ShowFileCommandBuilder builder, string[] tokens, ref int currentIndex)
    {
