...
public sealed class DeleteFileCommandParser : ICommandParser
{
    private readonly IReadOnlyList<IPositionalApplier<DeleteFileCommandBuilder>> _positionalAppliers;

    private readonly IFlagApplierLink<DeleteFileCommandBuilder>? _flagApplierChain;

    public DeleteFileCommandParser(
        IReadOnlyList<IPositionalApplier<DeleteFileCommandBuilder>> positionalAppliers,
        IFlagApplierLink<DeleteFileCommandBuilder>? applierChain)
    {
    ...
    private IParsingError? ParsePositional(DeleteFileCommandBuilder builder, string[] tokens, ref int currentIndex)
    {
        foreach (IPositionalApplier<DeleteFileCommandBuilder> positionalArgument
