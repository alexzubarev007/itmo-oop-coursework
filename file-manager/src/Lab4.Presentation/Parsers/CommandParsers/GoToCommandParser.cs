...
public sealed class GoToCommandParser : ICommandParser
{
    private readonly IReadOnlyList<IPositionalApplier<GoToCommandBuilder>> _positionalAppliers;

    private readonly IFlagApplierLink<GoToCommandBuilder>? _flagApplierChain;

    public GoToCommandParser(
        IReadOnlyList<IPositionalApplier<GoToCommandBuilder>> positionalAppliers,
        IFlagApplierLink<GoToCommandBuilder>? applierChain)
    {
