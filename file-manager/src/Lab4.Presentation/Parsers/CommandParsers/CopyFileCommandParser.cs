...
public sealed class CopyFileCommandParser : ICommandParser
{
    private readonly IReadOnlyList<IPositionalApplier<CopyFileCommandBuilder>> _positionalAppliers;

    private readonly IFlagApplierLink<CopyFileCommandBuilder>? _flagApplierChain;

    public CopyFileCommandParser(
        IReadOnlyList<IPositionalApplier<CopyFileCommandBuilder>> positionalAppliers,
        IFlagApplierLink<CopyFileCommandBuilder>? applierChain)
    {
